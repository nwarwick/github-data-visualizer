...
module.exports = function repos ($, url, callback) {
  ...
  var items = $('.js-repo-list').children();
  for(var i = 1; i < items.length; i++) {
    var r = {};
    var parent = $('.js-repo-list li:nth-child(' +i +') ').first()[0];
    var a = $(parent).find("a");
    var span = $(parent).find("span.mr-3");
    if (!span.length) {
      continue;
    }
    r.url     = a[0].attribs.href;
    r.name    = a[0].children[0].data.trim();
    ...
    r.lang    = span[0].children[0].data.trim();
    //console.log(r.lang);
    /*
